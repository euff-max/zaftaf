    ...
    <div class="bg-gray-800/95 rounded-2xl p-6 max-w-2xl w-full mx-4 border border-cyan-500/30">
        ...
        <div class="space-y-4">
            <div class="bg-gray-700/50 rounded-xl p-4">
                <h4 class="text-cyan-400 font-semibold mb-2">Détails du Colis</h4>
                <div class="grid grid-cols-2 gap-4 text-sm">
                    <div>
                        <span class="text-gray-400">Type:</span>
                        <span id="colis-type-display" class="text-white ml-2"></span>
                    </div>
                    <div>
                        <span class="text-gray-400">Poids:</span>
                        <span id="colis-poids-display" class="text-white ml-2"></span>
                    </div>
                </div>
            </div>

            <div class="bg-gray-700/50 rounded-xl p-4">
                <h4 class="text-cyan-400 font-semibold mb-2">Cargaisons Disponibles</h4>
                <div id="cargaisons-list" class="space-y-2 max-h-64 overflow-y-auto">
        ...
        <div class="mt-6 flex justify-end space-x-3">
            <button id="cancel-selection" class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-500 transition-colors">
                Annuler
            </button>
            <button id="confirm-selection" class="px-4 py-2 bg-cyan-500 text-white rounded-lg hover:bg-cyan-600 transition-colors" disabled>
                Confirmer
            </button>
        </div>
    </div>
